    ...
    <div class="grid grid-cols-3 gap-10">
        <div class="text-sm leading-6 w-full">
            <figure class="relative flex flex-col bg-white rounded-lg p-4 sm:p-6 md:p-8 w-full">
                <img src="https://images.unsplash.com/photo-1632910121591-29e2484c0259?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw4fHxjb2RlcnxlbnwwfDB8fHwxNzEwMTY0NjIzfDA&ixlib=rb-4.0.3&q=80&w=1080"
                    alt="" class="flex-none w-14 h-14 rounded-full object-cover mx-auto mb-4" loading="lazy"
                    decoding="async">
                <figcaption class="flex flex-col items-center space-y-2">
                    <div
                        class="text-base sm:text-lg md:text-xl text-slate-900 font-semibold dark:text-slate-600 text-center">
                        Selamat Datang
                    </div>
        ...
        <div class="col-span-1 bg-white border border-gray-300 rounded-lg shadow p-4">
            <div class="flex flex-col justify-center items-center h-full text-center">
                ...
                <p class="text-lg font-normal text-justify overflow-hidden text-ellipsis"
                    style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical;">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, impedit architecto voluptatum autem
                    laboriosam aliquam quis minus vitae nemo consequatur dolorum aliquid dic.
                </p>
            </div>
        </div>
    </div>
