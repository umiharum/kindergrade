    ...
    <dh-component>
        <div class="flex flex-no-wrap">
            ...
            <div style="min-height: 716px"
                class="w-64 absolute sm:relative bg-gray-400 shadow md:h-full flex-col justify-between flex">
                <div class="px-0">
                    <div class="h-14 flex w-full items-center bg-blue-950 justify-center">
                        <svg aria-label="Ripples. Logo" role="img" xmlns="http://www.w3.org/2000/svg" width="150"
                    ...
                    <div class="space-y-4">
                        ...
                        <h3 class="text-sm font-medium text-gray-800">Data</h3>
                        <x-nav-link href="/kelas" :active="request()->is('kelas')">Kelas</x-nav-link>
                        <a href="#"
                            class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">
                            <span>Guru</span>
                        </a>
                        <a href="#"
                            class="flex items-center px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">
                ...
                <div class="mt-4 space-y-1 px-5 mb-4">
                    <a href="#"
