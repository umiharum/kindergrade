    ...
    <div class="flex flex-no-wrap">
        ...
        <div class="w-64 absolute sm:relative bg-gray-400 shadow md:h-full flex flex-col justify-between">
            <div class="flex flex-col pb-2 bg-neutral-200 max-w-[280px]">
                <div
                    class="flex gap-0.5 px-10 py-2 text-base font-bold whitespace-nowrap rounded-none bg-sky-950 text-stone-500">
                    <img loading="lazy"
                ...
                <div class="flex flex-col mt-9 ml-8 max-w-full text-sm font-medium leading-5 text-zinc-700 w-[110px]">
                    <div class="flex gap-5 whitespace-nowrap text-zinc-900">
                        <img loading="lazy"
                            src="https://img.icons8.com/?size=100&id=sUJRwjfnGwbJ&format=png&color=000000"
                    ...
                    <div class="flex gap-5 mt-5 whitespace-nowrap">
                        <img loading="lazy"
                            src="https://img.icons8.com/?size=100&id=ggAxR7mNzNK6&format=png&color=000000"
                            class="shrink-0 w-[27px] h-[27px]" />
                    ...
                    <div class="flex gap-5 mt-5 whitespace-nowrap">
                        <img loading="lazy"
                            src="https://img.icons8.com/?size=100&id=Zo3-bT74qE1g&format=png&color=000000"
                            class="shrink-0 w-[27px] h-[27px]" />
                        <div>Bulanan</div>
                    </div>
                    <div class="flex gap-5 mt-5 whitespace-nowrap">
            ...
            <div class="flex gap-5 px-8 py-4 whitespace-nowrap mt-auto text-zinc-900 bg-gray-400">
                <img loading="lazy" src="https://img.icons8.com/?size=100&id=Q1xkcFuVON39&format=png&color=000000"
                    class="shrink-0 aspect-[1.06] w-[27px] h-[27px]" />
                <div>Logout</div>
            </div>
        </div>
        <!-- Sidebar ends -->
